...
function Search({searchBtn, setSearch, errormsg}) {
  return (
    <div className="flex flex-col space-y-6 w-full max-w-screen-sm bg-white p-10  rounded-xl ring-8 ring-white ring-opacity-40 dark:bg-slate-900 dark:text-white ">
